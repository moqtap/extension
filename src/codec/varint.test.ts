...
import { decodeVarint, encodeVarint, varintEncodedLength, VARINT_MAX } from './varint';
...
describe('varint — round-trip encode/decode', () => {
  const testValues = [
    0, 1, 2, 10, 37, 63,          // 1-byte range
    64, 100, 255, 1000, 15293, 16383,  // 2-byte range
    16384, 65535, 494878333, 1073741823,  // 4-byte range
    1073741824, 151288809941952652,       // 8-byte range
  ];
