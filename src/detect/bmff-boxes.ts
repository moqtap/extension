...
const KNOWN_BOX_TYPES = new Set([
  ...
  'moov', 'mvhd', 'mvex', 'trex',
  // Track structure
  'trak', 'tkhd', 'mdia', 'mdhd', 'hdlr', 'minf', 'dinf', 'stbl',
  // Sample table (init segment)
  'stsd', 'stts', 'stsc', 'stsz', 'stco', 'co64', 'ctts', 'stss',
  // Fragment structure
  ...
  'loch', 'loct', 'locs',
  // Common extensions
  'uuid', 'edts', 'elst', 'udta', 'meta', 'iloc', 'iinf',
  // Skip/free space
  'free', 'skip',
]);
 ...
 */
export function classifyVariant(boxes: BmffBox[], data: Uint8Array): MediaVariant {
 ...
 */
export function scanAndDetectMedia(data: Uint8Array, scanLimit = 256): PayloadMediaInfo | null {
