 ...
 */
export function parseStreamFraming(
  data: Uint8Array,
  draft?: string,
...
export function extractFirstPayload(
  data: Uint8Array,
  framing: ParsedStreamFraming,
): Uint8Array | null {
...
export function extractAllPayloads(
  data: Uint8Array,
  framing: ParsedStreamFraming,
): Uint8Array[] {
 ...
 */
export function parseDatagramGroupFraming(
  data: Uint8Array,
  draft?: string,
): ParsedStreamFraming | null {
  ...
  const tags: HeaderTag[] = [
    { label: 'datagram-group', value: '', kind: 'info' },
  ]
...
registerDraftParser('18', createCodecDraftParser('18'))
registerDraftParser('19', createCodecDraftParser('19'))
